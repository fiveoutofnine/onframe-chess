...
export async function GET(/* req: NextRequest */) {
  ...
  //const board = state.split(' ')[0].split('/');
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          <Bishop transform="translate(24 24)" />
          <path
    ...
    ),
    {
      width: 1200,
      height: 630,
      fonts: [{ name: 'Inter 400', data: await inter400, weight: 400 }],
    },
  );
}
...
export const Bishop: React.FC<JSX.IntrinsicElements['svg']> = (props) => {
  return (
    <svg
      width="24"
      height="24"
...
export const King: React.FC<JSX.IntrinsicElements['svg']> = (props) => {
  return (
    <svg
      width="24"
      height="24"
...
export const Knight: React.FC<JSX.IntrinsicElements['svg']> = (props) => {
  return (
    <svg
      width="24"
      height="24"
...
export const Pawn: React.FC<JSX.IntrinsicElements['svg']> = (props) => {
  return (
    <svg
      width="24"
      height="24"
...
export const Queen: React.FC<JSX.IntrinsicElements['svg']> = (props) => {
  return (
    <svg
      width="24"
      height="24"
...
export const Rook: React.FC<JSX.IntrinsicElements['svg']> = (props) => {
  return (
    <svg
      width="24"
      height="24"
